...
nonParametricExtrapolate = function(year, old) {  
  ...
  #ggplot() + stat_ecdf(aes(w_est), color = "red") + stat_ecdf(aes(b_est), color = "blue") + stat_ecdf(aes(w_tru), color = "orange") + stat_ecdf(aes(b_tru), color = "cornflowerblue") + xlim(-4, 14) 
